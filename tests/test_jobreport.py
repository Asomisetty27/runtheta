...
def test_jobid_filter_isolates_job(tmp_path):
    ...
    for o in (0, 1):
        for nm, base in (("nvidia_gpu_temperature_celsius", 60),
            ...
            result.append(s(nm, "cluster-n1:1", o, "AAA", base))
            result.append(s(nm, "cluster-n9:1", o, "BBB", base))
