...
class BaselineManager:
    ...
    def update(
        ...
        if gpu_index not in self._buffers:
            # Window-trimmed below; maxlen is an unconditional OOM backstop
            # (covers pathological sample rates / stalled timestamps).
            self._buffers[gpu_index] = deque(maxlen=100_000)
