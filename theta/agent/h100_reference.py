"""
H100 empirical reference — calibrated from the real E009 validation fleet.
...
immutable E009 validation export (operator de-identified). It replaces
...
against real silicon. It does NOT calibrate cause attribution — the E009
...
def positional_residual(rtheta: float, ordinal: int) -> float | None:
    ...
    node-05:2 case). Returns None for an unknown ordinal.
    """
