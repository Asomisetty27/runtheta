...
reference (E009-calibrated) to z-score against real silicon rather than
...
def build_feature_vector(
    *,
    ...
    #    a unit hidden in a structurally-cool HGX slot — the node-05:2 case the
    ...
    #    which is the honest steady-load gap the E009 analysis surfaced.
